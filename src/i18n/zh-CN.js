const zhCNCommands = {
  ...
  "\\sum_{}^{}": { descriptions: ["求和"] },
  "\\prod_{}^{}": { descriptions: ["求积"] },
  "\\pi": { descriptions: ["圆周率"] },
  e: { descriptions: ["自然底数"] },
  "!": { descriptions: ["阶乘"] },
  ...
  "\\times": { descriptions: ["叉乘"] },
  "\\div": { descriptions: ["除以"] },
  "\\cap": { descriptions: ["交"] },
  "\\cup": { descriptions: ["并"] },
  "\\emptyset": { descriptions: ["空集"] },
  ...
  "\\overrightarrow{}": { descriptions: ["射线"] },
  "\\%": { descriptions: ["百分"] },
  ...
  "\\lfloor {} \\rfloor": { descriptions: ["向下取整"] },
